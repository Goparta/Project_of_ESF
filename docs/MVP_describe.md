...
7. Рольова модель: студенти/викладачі/адмін (реєстрація та вхід простими email).
8. Basic admin panel: вручну підтверджувати / коригувати імпортовані записи.
9. Можливість створювати свій розклд для викладачів. Якщо є конфлікти - сказати. Запропонувати 2/3 альтернативи
10. Генератор розклду для викладачів (трішки ще фільтрів, щоб приблизно уявити по вимогах). Як мінімум - 2 пари на день для кожної групи (власні пари чи інших викладачів). Якщо є конфлікти - сказати. Запропонувати 2/3 альтернативи
